...
public class EditResourceOnClaimSetCommandService
{
    ...
    private void AddEnabledActionsToClaimSet(ResourceClaim modelResourceClaim, IReadOnlyCollection<ClaimSetResourceClaimAction> claimSetResourceClaimsToEdit, EdFi.Security.DataAccess.V1.Models.ClaimSet claimSetToEdit)
    {
