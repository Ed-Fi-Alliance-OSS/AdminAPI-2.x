...
internal class GetApiClientByIdQueryTests : PlatformUsersContextTestBase
{
    ...
    [Test]
    public void ShouldGetApliClientById()
    {
        ApiClient result = null;

        Transaction(usersContext =>
        {
            var query = new GetApiClientByIdQuery(usersContext);
            result = query.Execute(secondApiClientId);
        });
    ...
    private void LoadApiClients()
    {
        ...
        secondApiClientId = apiClient2.ApiClientId;
    }
}
