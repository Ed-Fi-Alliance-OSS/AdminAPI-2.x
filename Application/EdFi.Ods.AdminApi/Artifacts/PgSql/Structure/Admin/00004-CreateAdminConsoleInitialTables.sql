...
CREATE INDEX IF NOT EXISTS "IX_HealthChecks_EdOrgId" ON adminconsole.HealthChecks ("EdOrgId");
...
CREATE INDEX IF NOT EXISTS "IX_Instances_Id" ON adminconsole.Instances ("Id");
