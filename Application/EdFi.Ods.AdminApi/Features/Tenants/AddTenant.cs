...
public class AddTenant : IFeature
{
    ...
    {
        private readonly IAdminConsoleTenantsService _adminConsoleTenantsService;
        private readonly string _databaseEngine;

        public Validator([FromServices] IAdminConsoleTenantsService adminConsoleTenantsService, IOptions<AppSettings> options)
        {
        ...
        {
            var tenants = _adminConsoleTenantsService.GetTenantsAsync(true).Result;
