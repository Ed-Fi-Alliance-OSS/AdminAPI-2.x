...
public class FeatureConstants
{
    ...
    public const string OdsInstanceContextContextKeyDescription = "derivative type";
    public const string OdsInstanceContextContextValueDescription = "connection string"; 
}
