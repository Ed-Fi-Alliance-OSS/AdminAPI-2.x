...
public class AddTenantCommand
{
    ...
    private readonly IAppSettingsFileProvider _fileProvider;

    public AddTenantCommand(IAppSettingsFileProvider fileProvider)
    {
        _fileProvider = fileProvider;
    }

    public void Execute(IAddTenantModel model)
    {
        lock (_fileLock)
        {
