...
public class GetOdsInstanceDerivativesQuery : IGetOdsInstanceDerivativesQuery
{
    ...
    public GetOdsInstanceDerivativesQuery(IUsersContext usersContext, IOptions<AppSettings> options)
    {
        ...
        {
            { SortingConstants.OdsInstanceDerivativeTypeColumn, x => isSQLServerEngine ? EF.Functions.Collate(x.DerivativeType, DatabaseEngineEnum.SqlServerCollation) : x.DerivativeType },
            { SortingConstants.OdsInstanceDerivativeOdsInstanceIdColumn, x => x.OdsInstance.OdsInstanceId },
            { SortingConstants.DefaultIdColumn, x => x.OdsInstanceDerivativeId }
        };
