...
using EdFi.Ods.AdminApi.V1.DBTests;
...
public class SecurityTestDatabaseSetup
{
    ...
    private static async Task<string> DownloadDbPackage(string packageName, string version, string nugetSource, string downloadPath)
    {
