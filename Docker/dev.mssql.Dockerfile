...
COPY --from=assets ./Application/NuGet.Config EdFi.AdminConsole.InstanceMgrWorker.Provisioner/
COPY --from=assets ./Application/EdFi.AdminConsole.InstanceMgrWorker.Provisioner EdFi.AdminConsole.InstanceMgrWorker.Provisioner/
