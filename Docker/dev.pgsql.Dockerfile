...
RUN apk upgrade --no-cache && apk add --no-cache musl=1.2.5-r10
...
RUN apk upgrade --no-cache && \
    apk add --no-cache bash=5.2.26-r0 dos2unix=7.5.2-r0 gettext=0.22.5-r0 icu=74.2-r1 musl=1.2.5-r2 openssl=3.3.5-r0 postgresql14-client=14.10-r0 && \
