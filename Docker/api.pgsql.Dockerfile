...
RUN apk upgrade --no-cache && \
    apk add --no-cache bash=5.2.26-r0 dos2unix=7.5.2-r0 gettext=0.22.5-r0 icu=76.1-r1 jq=1.7.1-r0 musl=1.2.5-r10 openssl=3.3.5-r0 postgresql14-client=14.10-r0 unzip=6.0-r15 && \
